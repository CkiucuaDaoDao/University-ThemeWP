...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(universityData.root_url + "/wp-json/university/v1/universities?term=" + this.searchField.value);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkuniversity"] = globalThis["webpackChunkuniversity"] || [];
