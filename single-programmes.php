...
<div class="container container--narrow page-section">
  <div class="metabox metabox--position-up metabox--with-home-link">
    <p><a class="metabox__blog-home-link" href="<?php echo site_url('/programmes'); ?>"><i class="fa fa-home" aria-hidden="true"></i> Back to Programmes</a>
  ...
  if ($homepageEvents->have_posts()) {
    echo '<hr class="section-break">';
    echo '<h2 class="headline headline--medium"><strong>Upcoming ' . get_the_title() . ' event</strong></h2>';
